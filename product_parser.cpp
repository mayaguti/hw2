...
{
	Product* a = new Book("book", prodName_, price_, qty_, author_, isbn_);
	return a;
}
...
{
	Product* a = new Clothing("clothing", prodName_, price_, qty_, brand_);
	return a;
}
...
{
	Product* a = new Movie("movie", prodName_, price_, qty_, genre_, rating_);
	return a;
}
